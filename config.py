"""
Configuration file for HeyJenna - Multi-Platform Video Downloader
"""
...
class Config:
    ...
    # Video quality settings - Improved for better Instagram compatibility
    VIDEO_QUALITY = os.environ.get('VIDEO_QUALITY', 'best[height<=1080]/bestvideo+bestaudio/best')
    AUDIO_QUALITY = os.environ.get('AUDIO_QUALITY', 'bestaudio[ext=m4a]/bestaudio/best')
    ...
    COOKIE_FILES = {
        ...
        'reddit.com': 'www.reddit.com_cookies.txt'
    }
